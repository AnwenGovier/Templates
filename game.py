...
def normalise_input(user_input):
    ...
    'help'
    """
    temp_string1 = remove_spaces(user_input)
    temp_string2 = remove_punct(temp_string1)
    temp_string3 = remove_spaces(temp_string2)
    temp_string4 = remove_punct(temp_string3)
    temp_string5 = remove_spaces(temp_string4)
    temp_string6 = remove_punct(temp_string5)
    return temp_string6.lower()
    
    

def display_room(room):
    """This function takes a room as an input and nicely displays its name
    and description. The room argument is a dictionary with enties "name",
